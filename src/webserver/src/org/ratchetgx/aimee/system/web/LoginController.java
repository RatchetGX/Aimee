...
public class LoginController extends BaseController {
    ...
    public String login(ModelMap model, HttpServletRequest request) {
        ...
        */
    	...
    	String sessioncode = (String)request.getSession(true).getAttribute("validateCode");
    	
    	if (validatecode == null || "".equals(validatecode) || !sessioncode.toLowerCase().equals(validatecode)) {
            return "redirect:login.jsp?error=validateCode";
        }
    	Random random = new Random();
    	request.getSession(true).setAttribute("validateCode", "WX" + random.nextInt(99));
