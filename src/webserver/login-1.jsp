...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <input type="hidden" name="mode" value="db"/>
            ...
            <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top" style="width:980px; height:330px; background-image:url(resources/image/login/main_bg11.jpg); background-repeat:no-repeat;"><table width="40%" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tr>
